...
export const Form = () => {
    ...
    return (
        ...
        <form onSubmit={handleSubmit(onSubmit)}> 
            ...
            <input className='contact-placeholder' type="number" placeholder='Mobile Number' /> <br />
            ...
            <textarea className='contact-placeholder' name="" id="" placeholder='Message' cols="22" rows="10"></textarea> <br />
